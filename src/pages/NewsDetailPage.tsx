...
const NewsDetailPage: React.FC = () => {
  ...
  const newsDetail: NewsDetail = {
    id: '1',
    title: '知聊智能助手2.0版本正式发布：全新升级，带来更智能的对话体验',
    content: `
      知聊科技今日正式发布智能助手2.0版本，这是继去年1.0版本发布后的重大升级。新版本在原有功能基础上进行了全面优化和扩展，为用户带来更智能、更便捷的对话体验。
      ...
      知聊科技将继续投入大量资源进行产品研发和技术创新，为用户带来更多惊喜。我们计划在未来几个月内推出更多新功能，包括：
