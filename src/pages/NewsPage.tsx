...
const NewsPage: React.FC = () => {
  ...
  const newsItems: NewsItem[] = [
    {
      id: '1',
      title: '知聊智能助手2.0版本正式发布',
      summary: '全新升级的智能助手支持更多场景和功能，为用户带来更好的使用体验。',
      content: '知聊智能助手2.0版本在原有功能基础上进行了全面升级，新增了多语言支持、语音交互、图像识别等功能。同时优化了对话体验，提供更智能的上下文理解和个性化推荐。',
      date: '2024-03-15',
      category: '产品更新',
      tags: ['产品更新', 'AI', '用户体验'],
    ...
    {
      id: '2',
      title: '知聊完成新一轮融资，加速产品研发',
      summary: '知名投资机构领投，助力知聊在AI领域持续创新。',
      content: '知聊科技今日宣布完成新一轮融资，由知名投资机构领投。本轮融资将主要用于产品研发、技术升级和市场扩张，进一步巩固知聊在AI领域的领先地位。',
      date: '2024-03-10',
      category: '公司动态',
      tags: ['融资', '公司动态', '发展'],
    ...
    {
      id: '3',
      title: '知聊技术团队分享：大语言模型应用实践',
      summary: '深入探讨大语言模型在实际应用中的挑战和解决方案。',
      content: '知聊技术团队分享了在大语言模型应用过程中的实践经验，包括模型选择、性能优化、安全防护等方面的技术细节，为行业提供了有价值的参考。',
      date: '2024-03-05',
      category: '技术分享',
      tags: ['技术分享', 'AI', '大语言模型'],
    ...
    },
    {
      ...
      summary: '一位企业用户分享使用知聊智能助手提升工作效率的经验。',
      content: '某企业高管分享了使用知聊智能助手的心得，包括如何利用AI助手处理日常事务、整理会议纪要、分析数据等，显著提升了工作效率。',
      date: '2024-02-20',
      category: '用户故事',
      tags: ['用户故事', '效率提升', '企业应用'],
